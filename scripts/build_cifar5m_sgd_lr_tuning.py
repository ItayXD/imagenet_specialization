...
DEFAULT_CONFIG_PREFIX = 'cifar5m_exchangeability_sgd_lr_tuning_w64'
DEFAULT_RUN_PREFIX = 'exchangeability_cifar5m_sgd_lr_tuning_w64'
DEFAULT_BASE_DIR_ROOT = DEFAULT_CLUSTER_ROOT + '/exchangeability_runs/cifar5m_sgd_lr_tuning/w64'
DEFAULT_MANIFEST_PATH = 'conf/manifests/cifar5m/exchangeability_manifest_sgd_lr_tuning_w64.csv'
...
def parse_args() -> argparse.Namespace:
    parser = argparse.ArgumentParser(description='Build width-64 CIFAR-5M SGD learning-rate tuning configs.')
