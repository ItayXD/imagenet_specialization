...
export IMAGENET_BASE_SAVE_DIR="${IMAGENET_BASE_SAVE_DIR:-${EXCHANGEABILITY_ROOT}/exchangeability_imagenet}"
export CIFAR5M_BASE_SAVE_DIR="${CIFAR5M_BASE_SAVE_DIR:-${EXCHANGEABILITY_ROOT}/exchangeability_cifar5m}"
