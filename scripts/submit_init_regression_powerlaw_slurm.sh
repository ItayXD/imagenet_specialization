...
NORM_TYPE="${INIT_REG_NORM_TYPE:-batchnorm}"
...
echo "dataset=${DATASET} widths=${WIDTHS[*]} residual_scale_init=${RESIDUAL_SCALE_INIT} feature_preproc=${FEATURE_PREPROC} pool_mode=${POOL_MODE} norm_type=${NORM_TYPE}"
