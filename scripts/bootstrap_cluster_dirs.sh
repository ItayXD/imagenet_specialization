...
mkdir -p "${IMAGENET_BASE_SAVE_DIR}"
mkdir -p "${IMAGENET_BASE_SAVE_DIR}/slurm_logs"
mkdir -p "${CIFAR5M_BASE_SAVE_DIR}"
mkdir -p "${CIFAR5M_BASE_SAVE_DIR}/slurm_logs"
...
echo "  IMAGENET_BASE_SAVE_DIR=${IMAGENET_BASE_SAVE_DIR}"
echo "  CIFAR5M_BASE_SAVE_DIR=${CIFAR5M_BASE_SAVE_DIR}"
