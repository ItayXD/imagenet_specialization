...
def test_resolve_run_id_latest_prefix_ignores_smoke_runs(tmp_path: Path) -> None:
    _make_dir(tmp_path, "exchangeability_job1", 100)
    _make_dir(tmp_path, "exchangeability_cifar5m_smoke_20260320-180651_2678785_eb729e43", 200)
    assert _resolve_run_id(str(tmp_path), "exchangeability", "latest_prefix") == "exchangeability_job1"
...
def test_resolve_width_dirs_latest_prefix_ignores_smoke_runs(tmp_path: Path) -> None:
    _make_dir(tmp_path, "exchangeability_job1", 100, widths=(512,))
    _make_dir(
        tmp_path,
        "exchangeability_cifar5m_smoke_20260320-180651_2678785_eb729e43",
        200,
        widths=(512,),
    )
    ...
    width_dirs, width_sources = _resolve_width_dirs(
        ...
        "exchangeability",
        "latest_prefix",
        requested_widths=[512],
    )

    assert set(width_dirs.keys()) == {512}
    assert width_sources[512] == "exchangeability_job1"
