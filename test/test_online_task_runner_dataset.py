...
def test_online_task_runner_builds_loader_from_training_config_for_imagenet(tmp_path, monkeypatch):
    observed = {}
...
def test_online_task_runner_forces_single_process_loader_for_cifar5m(tmp_path, monkeypatch):
    observed = {}
    ...
    assert observed['kwargs']['persistent_workers'] is False
    assert observed['kwargs']['shuffle'] is True
    assert observed['train_loader'] == 'train-loader'
